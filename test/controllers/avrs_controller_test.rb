...
class AvrsControllerTest < ActionController::TestCase
  ...
  test "should create avr" do
    assert_difference('Avr.count') do
      post :create, avr: { date_off: @avr.date_off, date_on: @avr.date_on, material: @avr.material, mmm_id: @avr.mmm_id, type_avr: @avr.type_avr, user_id: @avr.user_id }
    end
  ...
  test "should update avr" do
    patch :update, id: @avr, avr: { date_off: @avr.date_off, date_on: @avr.date_on, material: @avr.material, mmm_id: @avr.mmm_id, type_avr: @avr.type_avr, user_id: @avr.user_id }
    assert_redirected_to avr_path(assigns(:avr))
  end
