...
class MmmsControllerTest < ActionController::TestCase
  ...
  test "should create mmm" do
    assert_difference('Mmm.count') do
      post :create, mmm: { adress: @mmm.adress, ingress: @mmm.ingress, ip: @mmm.ip, mdu: @mmm.mdu, mod: @mmm.mod, porch: @mmm.porch, sys_name: @mmm.sys_name, tkd: @mmm.tkd }
    end
  ...
  test "should update mmm" do
    patch :update, id: @mmm, mmm: { adress: @mmm.adress, ingress: @mmm.ingress, ip: @mmm.ip, mdu: @mmm.mdu, mod: @mmm.mod, porch: @mmm.porch, sys_name: @mmm.sys_name, tkd: @mmm.tkd }
    assert_redirected_to mmm_path(assigns(:mmm))
  end
